...
public class RolDTO implements Serializable {
	...
	public RolDTO(Rol rol) {
		this.rolCodigo = rol.getRolCodigo();
		this.rolNombre = rol.getRolNombre();
		this.rolAestado = rol.isRolEstado();

		/* Llaves Foraneas */
		// Rol
		if (rol.getRol() != null && rol.getRol().getRolCodigo() > 0L) {
			rolDTO = new RolDTO();
			rol.setRolCodigo(rol.getRol().getRolCodigo());
		}
